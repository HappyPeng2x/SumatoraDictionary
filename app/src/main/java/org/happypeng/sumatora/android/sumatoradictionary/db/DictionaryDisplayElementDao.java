...
public interface DictionaryDisplayElementDao {
    @Query("SELECT DictionaryDisplayElement.entryOrder, DictionaryDisplayElement.seq, "
            ...
            + "DictionaryDisplayElement.lang, DictionaryDisplayElement.lang_setting, DictionaryDisplayElement.gloss, DictionaryDisplayElement.example_sentences, "
            + "DictionaryDisplayElement.example_translations, "
            + "DictionaryBookmark.memo  "
            + "FROM DictionaryDisplayElement LEFT JOIN DictionaryBookmark ON DictionaryDisplayElement.seq = DictionaryBookmark.seq "
            + "WHERE ref=:ref "
    ...
    @Query("SELECT DictionaryDisplayElement.entryOrder, DictionaryDisplayElement.seq, "
            ...
            + "DictionaryDisplayElement.misc, DictionaryDisplayElement.lsource, DictionaryDisplayElement.dial, "
            + "DictionaryDisplayElement.s_inf, DictionaryDisplayElement.field, DictionaryBookmark.bookmark, "
            + "DictionaryDisplayElement.lang, DictionaryDisplayElement.lang_setting, DictionaryDisplayElement.gloss, "
            + "DictionaryDisplayElement.example_sentences, DictionaryDisplayElement.example_translations, "
            + "DictionaryBookmark.memo "
            + "FROM DictionaryDisplayElement LEFT JOIN DictionaryBookmark ON DictionaryDisplayElement.seq = DictionaryBookmark.seq "
            + "WHERE ref=:ref "
            + "ORDER BY DictionaryDisplayElement.entryOrder, "
